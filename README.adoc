...
image:https://img.shields.io/badge/commitizen-friendly-brightgreen.svg[alt="Commitizen friendly",link="http://commitizen.github.io/cz-cli/",window=_blank]

image:https://github.com/paneron/paneron/actions/workflows/macos-latest.yml/badge.svg?branch=release[alt="macOS build",link="https://github.com/paneron/paneron/actions/workflows/macos-latest.yml",window=_blank]
image:https://github.com/paneron/paneron/actions/workflows/ubuntu-latest.yml/badge.svg?branch=release[alt="Ubuntu build",link="https://github.com/paneron/paneron/actions/workflows/ubuntu-latest.yml",window=_blank]
image:https://github.com/paneron/paneron/actions/workflows/macos-latest.yml/badge.svg?branch=release[alt="macOS build",link="https://github.com/paneron/paneron/actions/workflows/windows-latest.yml",window=_blank]
